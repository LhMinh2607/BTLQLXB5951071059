...
--1. Kiểm tra input của Staff (Nhân viên)
			...
			BEGIN
				...
				IF((SELECT Chucvu FROM inserted) NOT IN (N'Tài xế', N'Tiếp Viên'))
					BEGIN
						...
						ROLLBACK TRAN
						END
				IF(((SELECT Chucvu FROM inserted)=N'Tiếp Viên') AND ((SELECT So_Ve_Ban_Ra_Trong_Ngay FROM inserted) < 50))
					BEGIN
						PRINT N'Số vé phải lớn hơn hoặc bằng 50 đối với tiếp viên.'
						ROLLBACK TRAN
						END
...
INSERT INTO STAFF VALUES ('08A420','08',N'Nguyễn Nguyên Nguyện','9/6/1970',11000000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Cis',N'Tiếp Viên',80)
INSERT INTO STAFF VALUES ('08A420','08',N'Nguyễn Nguyên Nguyện','9/6/1970',11000000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Nam',N'Lơ xe',80)
INSERT INTO STAFF VALUES ('08A420','08',N'Nguyễn Nguyên Nguyện','9/6/1970',11000000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Nam',N'Tiếp Viên',40)
INSERT INTO STAFF VALUES ('08A420','08',N'Nguyễn Nguyên Nguyện','9/6/1970',300000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Nam',N'Tiếp Viên',80)
INSERT INTO STAFF VALUES ('08A420','08',N'Nguyễn Nguyên Nguyện','9/6/2005',11000000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Nam',N'Tiếp Viên',80)

--2. Kiểm tra sửa của Staff (Nhân viên)
...
INSERT INTO STAFF VALUES ('08A421','08',N'Nguyễn Thử Nghiệm','9/6/1970',11000000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Nam',N'Tiếp Viên',50)
UPDATE STAFF SET MaTuyen='08',HoTen=N'Nguyễn Nguyên Nguyện', NgaySinh='9/6/1970', Luong=11000000, DiaChi=N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM', GioiTinh= N'Cis', Chucvu=N'Tiếp Viên',So_ve_ban_ra_trong_ngay=80 WHERE MaNV='08A421'
UPDATE STAFF SET MaTuyen='08',HoTen=N'Nguyễn Nguyên Nguyện', NgaySinh='9/6/1970', Luong=11000000, DiaChi=N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM', GioiTinh= N'Nam', Chucvu=N'Lơ xe',So_ve_ban_ra_trong_ngay=80  WHERE MaNV='08A421'
UPDATE STAFF SET MaTuyen='08',HoTen=N'Nguyễn Nguyên Nguyện', NgaySinh='9/6/1970', Luong=11000000, DiaChi=N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM', GioiTinh= N'Nam', Chucvu=N'Tiếp Viên',So_ve_ban_ra_trong_ngay=40  WHERE MaNV='08A421'
UPDATE STAFF SET MaTuyen='08',HoTen=N'Nguyễn Nguyên Nguyện', NgaySinh='9/6/1970', Luong=110000, DiaChi=N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM', GioiTinh= N'Nam', Chucvu=N'Tiếp Viên',So_ve_ban_ra_trong_ngay=80  WHERE MaNV='08A421'
UPDATE STAFF SET MaTuyen='08',HoTen=N'Nguyễn Nguyên Nguyện', NgaySinh='9/6/2005', Luong=11000000, DiaChi=N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM', GioiTinh= N'Nam', Chucvu=N'Tiếp Viên',So_ve_ban_ra_trong_ngay=80 WHERE MaNV='08A421'
...
INSERT INTO STAFF VALUES ('69','08',N'Nguyễn Ngôn','9/6/1970',11000000,N'10 Lạc Long Quân P.10 Q.Tân Bình, TP.HCM',N'Nam',N'Tiếp Viên',80)
DELETE STAFF WHERE MaNV='69'


--1. Kiểm tra nhập của BUS (Xe buýt)
...
--2. Kiểm tra sửa của BUS (Xe buýt)
...
INSERT INTO TICKET_PACK VALUES ('421HS01','421A69',3000,N'Học Sinh Sinh Viên')
INSERT INTO TICKET_PACK VALUES ('421HS02','421A69',3000,N'Vé Thường')
...
INSERT INTO TICKET_PACK VALUES ('42HS01','42A69',3000,N'Học Sinh Sinh Viên')
INSERT INTO TICKET_PACK VALUES ('42HS02','42A69',3000,N'Vé Thường')
